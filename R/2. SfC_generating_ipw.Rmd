...
nrow(ipw_data)
```
The total count is for rating unit, not for establishment. The Skills for Care data for the same location-id will be duplicated for different measuring units. 
