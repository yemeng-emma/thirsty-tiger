...
Updated 3/8/2024 to add new variable `age` and save the combined data to prepare for further analysis
...
# mutate NA only for jr28flag = 1 and jr29 = 1, respectively
  ...
  mutate(average_totalstaff = totalstaff - total_starters + total_leavers)  %>% 
